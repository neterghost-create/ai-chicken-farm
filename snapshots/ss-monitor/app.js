        ...
        const I18N = {
            'zh-Hant': {
                ...
                'status.candidate': '候選', 'status.whitelisted': '白名單', 'status.blacklisted': '拉黑',
            ...
            'zh-Hans': {
                ...
                'status.candidate': '候选', 'status.whitelisted': '白名单', 'status.blacklisted': '拉黑',
            ...
            'en': {
                ...
                'hero.ss': 'Rooster King', 'hero.vps': 'Coop', 'hero.pool': 'Egg Pool', 'hero.feed': 'Feed Sources',
                ...
                'pool.totalNodes': 'Tested Nodes', 'pool.protocols': 'State Dist', 'pool.lastRun': 'Last Probe',
                ...
                'pool.blacklisted': '⛔ Blacklisted (by unblock time)',
                ...
                'status.candidate': 'Candidate', 'status.whitelisted': 'Whitelist', 'status.blacklisted': 'Blocked',
        ...
        $id('nodeLimitToggle')?.addEventListener('change', renderNodeTable);
